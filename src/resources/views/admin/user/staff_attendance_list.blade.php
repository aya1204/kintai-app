...
<div class="attendance-list-form">
    ...
    <div class="month-list-form">
        ...
        {{-- 前月 --}}
        <a class="previous-month" href="{{ route('admin.staff.attendance.list', ['user' => $user->id, 'month' => $prevMonth]) }}"><img class="left-arrow-icon" src="{{ asset('storage/images/arrow.png') }}" alt="calendar">前月</a>
        ...
        {{-- 翌月 --}}
        <a class="next-month" href="{{ route('admin.staff.attendance.list', ['user' => $user->id, 'month' => $nextMonth]) }}">翌月<img class="right-arrow-icon" src="{{ asset('storage/images/arrow.png') }}" alt="calendar">
        </a>
    </div>
